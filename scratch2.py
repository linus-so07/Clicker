...
class CookieUpgradeClass(CookieClass):
	...
	def create_page_buttons(self):
		...
		page_down_button = tk.Button(frame3, text="<", command=self.page_down)
		page_down_button.grid(row=0, column=0, pady=5)

		page_down_button = tk.Button(frame3, text=">", command=self.page_up)
		page_down_button.grid(row=0, column=2, pady=5)
